...
S      = 12.5;       % “per‐kg” scaling factor
P      = 20;      % “power” factor (tune as needed)
...
snapshot_times = linspace(10,max_time,10); % [2.5, 5.0, 7.5, 10.0];
...
for tau_q = 20:10:70
    ...
    title(['Temperature Profile T(x); Tau_q =',num2str(tau_q)]);
